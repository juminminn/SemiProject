...
public class SearchDaoImpl implements SearchDao {
	...
	public List<ChallengeList> getAllList(Connection conn, String word, Paging paging) {
		...
		sql += "SELECT * FROM(  " + 
				...
				"SELECT ch_title,C.u_no,U.u_id,ch_stored_name,ch_start_date, ch_likes FROM CHALLENGE C  " + 
				"INNER JOIN users U  " + 
				"on U.u_no = C.u_no  " + 
				"WHERE CH_TITLE LIKE '%'|| ? || '%'  " + 
				"OR CH_CONTENT LIKE '%'|| ? || '%' "+
	...
	public List<ChallengeList> getDetailList(Connection conn, String word, String orderby, String[] category,
		...
		sql += "SELECT * FROM(  " + 
				"SELECT ROWNUM rnum, list.*  FROM(  " + 
				"SELECT * FROM(   " + 
				"SELECT ch_title,ch_content,C.u_no, U.u_id, ch_stored_name, ch_start_date, ch_likes, ch_create_date, count(P.u_no)   " + 
				"FROM CHALLENGE C  " + 
				"INNER JOIN users U  " + 
				"on U.u_no = C.u_no   " + 
				...
				"GROUP BY ch_title, ch_content, C.u_no, U.u_id, ch_stored_name,ch_start_date, ch_likes, ch_create_date  " + 
