...
public class AdminComplaintPaging {
	...
	//총 게시글 수를 입력하는 생성자
	public AdminComplaintPaging(int totalCount) {
	...
	public AdminComplaintPaging(int totalCount, int curPage) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdminComplaintPaging(int totalCount, int curPage, int listCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
	...
	public AdminComplaintPaging(int totalCount, int curPage, int listCount, int pageCount) {
		setTotalCount(totalCount);
		setCurPage(curPage);
		setListCount(listCount);
	...
	public String toString() {
		return "ComplaintPaging [curPage=" + curPage + ", totalCount=" + totalCount + ", listCount=" + listCount
