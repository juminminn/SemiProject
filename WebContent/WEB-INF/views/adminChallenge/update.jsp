...
<table class="table table-responsive text-center">
		...
		<tr><td>참가비</td><td><input type="number" id="ch_money" name="ch_money" class="form-control" style="width:100%"value="<%=updateChallenge.getChMoney()%>"/></td></tr>
		...
		<tr><td>시작날짜</td><td><input type="date" id="ch_start_date" name="ch_start_date" class="form-control" style="width:100%" value="<%=updateChallenge.getChStartDate()%>"/><span id="messageStartDate"></span></td></tr>
		<tr><td>마감날짜</td><td><input type="date" id="ch_end_date" name="ch_end_date" class="form-control" style="width:100%" value="<%=updateChallenge.getChEndDate()%>"/><span id="messageEndDate"></span></td></tr>
		<tr><td >인증빈도</td><td>
