...
<div class="card-body center-block">
	<div class="table-responsive">
		...
		<tbody>
            ...
            <td>개설자 경고</td>
 			<td><input type="text" name="chUcaution" class="form-control" value="<%=request.getAttribute("chUcaution") %>" readonly></td>                                                                            
            </tr>                        
            ...
            <td>인증방법</td>                                
   			...
   			<td>조치내역</td>                              
    		<td><input type="text" name="comManage" class="form-control" value="<%=complaint.getComManage() %>" readonly ></td>                                              
 			</tr>
