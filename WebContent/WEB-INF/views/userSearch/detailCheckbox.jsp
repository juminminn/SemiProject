...
<div class="container">
	<div class="detail">
		...
		<div><label class="checkbox-inline"><input type="checkbox" id = "study" class="checkbox" name="ca_no" value = "3">공부</label></div>
		<div><label class="checkbox-inline"><input type="checkbox" id = "hobby" class="checkbox" name="ca_no" value = "4">취미</label></div>
		<div><label class="checkbox-inline"><input type="checkbox" id = "language" class="checkbox" name="ca_no" value = "5">외국어</label></div>
		<div><label class="checkbox-inline"><input type="checkbox" id = "financial" class="checkbox" name="ca_no" value = "6">재테크</label></div>
		<div><label class="checkbox-inline"><input type="checkbox" id = "habbits" class="checkbox" name="ca_no" value = "7">생활습관</label></div>
		</div>
		<div class="selectbox">
